        ...
        <div className="w-full px-2 max-w-6xl m-auto ">
            ...
            <form className={`${props.mode==='dark'? 'bg-[#322F3D] text-white' : 'bg-white text-gray-700'} shadow-md rounded p-3 md:p-6 mb-4`} onSubmit={handleAddNote}>
                ...
                <div className="flex items-center justify-between">
                    <button   type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => props.showAlert("Note has been addded successfully!", "bg-green-200", "text-green-600", "Success") }>Add Note</button>
                </div>
            </form>
        </div>
    )
